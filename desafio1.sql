...
CREATE TABLE SpotifyClone.album (
    ...
    FOREIGN KEY (id_artistas) REFERENCES SpotifyClone.artistas(id)
) engine = InnoDB;

CREATE TABLE SpotifyClone.artistas_seguidos (
    id_usuario INT NOT NULL,
    id_artistas INT NOT NULL,
    CONSTRAINT PRIMARY KEY(id_usuario, id_artistas),
...
CREATE TABLE SpotifyClone.reproducoes (
    ...
    FOREIGN KEY (id_usuario) REFERENCES SpotifyClone.usuario(id),
    FOREIGN KEY (id_musicas) REFERENCES SpotifyClone.musicas(id)
) engine = InnoDB;
...
INSERT INTO SpotifyClone.usuario (nome, idade, id_plano, data_assinatura)
VALUES
...
INSERT INTO SpotifyClone.album (nome, id_artistas, ano_de_lancamento)
VALUES
  ('Envious',1, 1990),
  ('Exuberant',1, 1993),
...
INSERT INTO SpotifyClone.artistas_seguidos (id_usuario, id_artistas)
VALUES
  (1,1),
  (1,4),
  (1,3),
...
INSERT INTO SpotifyClone.reproducoes (id_usuario, id_musicas,data_reproducao)
VALUES
